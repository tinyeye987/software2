...
const StatCard = ({ numberOfMumbers, yearOfTheProject, lectureName }) => {
  return (
        ...
        <div class="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:">
          <div class="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
            <div>
              ...
              <p class="mt-1 text-gray-500">Number of Members</p>
            </div>
            ...
            <div>
              ...
              <p class="mt-1 text-gray-500">Year of the Project</p>
            </div>

            <div>
              <p class="text-3xl font-semibold text-blue-600">{lectureName}</p>
              <p class="mt-1 text-gray-500">Lecture incharge</p>
            </div>
          </div>
        </div>
      </div>
